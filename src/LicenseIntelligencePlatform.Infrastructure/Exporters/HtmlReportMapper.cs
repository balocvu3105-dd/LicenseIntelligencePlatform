...
public sealed class HtmlReportMapper : IReportMapper
{
    ...
    public async Task ExportAsync(ScanReport report, Stream outputStream, CancellationToken cancellationToken = default)
    {
        ...
        sb.AppendLine("        table { width: 100%; min-width: 2400px; border-collapse: collapse; table-layout: auto; }");
        ...
        sb.AppendLine("        .col-pkg { min-width: 200px; width: 14%; word-break: break-word; }");
        sb.AppendLine("        .col-ver { min-width: 140px; width: 8%; word-break: normal; overflow-wrap: anywhere; }");
        sb.AppendLine("        .col-pub { min-width: 160px; width: 10%; word-break: break-word; }");
        sb.AppendLine("        .col-path { min-width: 240px; width: 12%; word-break: normal; overflow-wrap: anywhere; font-family: ui-monospace, SFMono-Regular, Consolas, monospace; }");
        sb.AppendLine("        .col-dt { min-width: 110px; width: 6%; white-space: normal; }");
        sb.AppendLine("        .col-mod { min-width: 210px; width: 10%; white-space: normal; }");
        sb.AppendLine("        .col-use { min-width: 210px; width: 10%; white-space: normal; }");
        sb.AppendLine("        .col-src { min-width: 180px; width: 9%; word-break: break-word; }");
        sb.AppendLine("        .col-lic { min-width: 130px; width: 7%; text-align: center; }");
        sb.AppendLine("        .col-cnf { min-width: 130px; width: 7%; text-align: center; }");
        sb.AppendLine("        .col-det { min-width: 160px; width: 8%; word-break: break-word; }");
        sb.AppendLine("        .col-art { min-width: 340px; width: 15%; word-break: break-word; }");
        sb.AppendLine("        th.col-lic, th.col-cnf { text-align: center; }");
        sb.AppendLine("        code { background: rgba(15, 23, 42, 0.6); padding: 0.2rem 0.5rem; border-radius: 4px; font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace; font-size: 0.82rem; color: #38bdf8; word-break: normal; overflow-wrap: anywhere; white-space: normal; display: inline-block; line-height: 1.35; }");
